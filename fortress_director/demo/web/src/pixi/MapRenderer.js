...
export class MapRenderer {
    constructor(host, options = {}) {
        ...
        Object.defineProperty(this, "structureLayer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "npcLayer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "markerLayer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "effectsLayer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "tileTextures", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "npcSprites", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
        });
        Object.defineProperty(this, "structureSprites", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
        });
        Object.defineProperty(this, "markerMetas", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
        ...
        Object.defineProperty(this, "selectionHighlight", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "hoverId", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "atmosphereFx", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "fireTextures", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
     ...
     */
    animateMove(npcId, from, to, duration) {
        ...
        this.animateNpc(entry);
    }
    applyAtmosphere(state, audioHint) {
    ...
    syncStructures(state) {
        ...
        for (const [id, entry] of Object.entries(state.structures)) {
            ...
            sprite.scale.set(1);
            const graphics = sprite.getChildAt(0);
            graphics.clear();
            const color = ratio > 0.66 ? 0x4ade80 : ratio > 0.33 ? 0xfacc15 : 0xf87171;
            graphics.beginFill(color, 0.5 + ratio * 0.5);
            graphics.drawRoundedRect(-this.tileSize * 0.45, -this.tileSize * 0.45, this.tileSize * 0.9, this.tileSize * 0.9, 6);
            graphics.endFill();
            if (entry.on_fire) {
                const flame = sprite.getChildAt(1);
                flame.visible = true;
    ...
    syncNpcs(state) {
        ...
        for (const [id, payload] of Object.entries(state.npcPositions)) {
            ...
            this.attachTooltip(existing.sprite, `${payload.name ?? id}\nHealth ${payload.health}% | Morale ${payload.morale}%`);
            if (moved) {
                existing.animation = {
    ...
    applyNpcVisuals(sprite, payload) {
    ...
    syncMarkers(state) {
        ...
        for (const marker of state.eventMarkers) {
            seen.add(marker.id);
            let container = this.markerLayer.children.find((child) => child.name === marker.id);
            if (!container) {
    ...
    updateSelectionHighlight(x, y) {
        ...
        this.selectionHighlight.drawRect(this.padding + tileX * this.tileSize, this.padding + tileY * this.tileSize, this.tileSize, this.tileSize);
    }
    attachTooltip(displayObject, text) {
        if (!this.tooltipEl) {
        ...
        carrier.on("pointerover", (event) => {
            const content = event.currentTarget.__fdTooltipText ?? text;
...
export function summarizeMap(state, gridSize = DEFAULT_GRID_SIZE) {
    return {
