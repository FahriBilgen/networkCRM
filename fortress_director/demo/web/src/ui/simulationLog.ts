import type { CombatSummaryEntry, WorldTickDeltaPayload } from "../types/ui";

export function formatWorldTickLog(delta?: WorldTickDeltaPayload | null): string | null {
  if (!delta) {
    return null;
  }
...
export function formatCombatLog(entry: CombatSummaryEntry): string {
